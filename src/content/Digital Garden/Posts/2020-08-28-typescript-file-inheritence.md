...
This all seems fine, but what happens when we want to use both `RequestUser` and `DatabaseUser` interfaces in our API handler, keeping in mind the [`import * as ...`](https://jeeb.uk/typescript/2020/06/27/typescript-star-as.html) patten previously described?
